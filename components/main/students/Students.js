...
const Students = (props) => {
  ...
  return (
    <View style={styles.container}>
      <Image
        source={require("../../../assets/all_students.png")}
        style={{
          position: "absolute",
          width: "100%",
          height: "100%",
              ...
              if (textSearch === "") {
                return (
                  ...
                  >
                    ...
                    >
                      <Text style={styles.studentViewMoreButtonText}>View</Text>
                      <Text style={styles.studentViewMoreButtonText}>More</Text>
                    </TouchableOpacity>
                  </View>
                );
              }
                ...
                return (
                  ...
                  >
                    ...
                    <View style={styles.studentInfo}>
                      ...
                      <Text style={styles.studentCourse}>Java</Text>
                    </View>
                    <TouchableOpacity
                      style={styles.studentViewMoreButton}
                      onPress={() => {
