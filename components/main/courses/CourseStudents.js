        ...
        <ScrollView style={styles.scrollView}>
          ...
          <FlatList
            ...
            renderItem={({ item }) => {
              if (textSearch === "") {
                if (
                  props.route.params == item.courses[0] ||
                  props.route.params == item.courses[1] ||
                  props.route.params == item.courses[2] ||
                  props.route.params == item.courses[3]
                ) {
                  return (
                    <View
                      style={[
                  ...
                  return (
                    ...
                    >
                      ...
                      <View style={styles.studentInfo}>
                        ...
                        <Text style={styles.studentCourse}>{item.courses}</Text>
                      </View>
                      <TouchableOpacity
                        style={styles.studentViewMoreButton}
                        onPress={() => {
